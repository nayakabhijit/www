...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body class="project_detail_page">
    	<div id="wrapper_content">
			...
			<section id="flexslider_wrapper">
				<div id="flexslider_wrapper_inner">
					<div id="flexslider_block">
						<div id="flexslider_project">
							<ul class="slides">
								<li><img src="images/pic_project_03.jpg" alt=""></li>
								<li><img src="images/pic_project_04.jpg" alt=""></li>
								<li><img src="images/pic_project_05.jpg" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
				<div id="flexslider_margin"> </div>
			</section>
			<div class="wrapper">
					...
					<article class="post">
						<div class="entry">
							<div class="col col_1_3">
								...
								<p><strong>Client:</strong> Best PSD Freebies<br>
								<strong>Date:</strong> October, 2013<br>
								<strong>Website:</strong> <a href="http://www.bestpsdfreebies.com">www.bestpsdfreebies.com</a></p>
							</div>
							<div class="col col_1_3">
								<h3>Project Goals</h3>
			...
			<div class="wrapper">
				<section class="call_action bottom">
					<div>
						<h2>Do You Like Free Web Design Resources?</h2>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent justo ligula, interdum ut lobortis quis, interdum vitae metus. Proin fringilla metus non nulla cursus, sit amet rutrum est pretium.</p>
						<p><a target="_blank" href="http://www.bestpsdfreebies.com" class="btn">Check Us Out</a></p>
					</div>
				</section>
			</div><!-- /wrapper -->
    	</div>
