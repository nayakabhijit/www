...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Deliver Theme | Shortcodes Full Width</title>
							...
							<li>
								...
								<div class="drop">
									...
									<ul>
										...
										<li>
											<a class="active_sub" href="shortcodes-full-width.php">Full Width & Shortcodes <span class="drops"></span></a>
											<div class="drop">
												<ul>
